...
import DebounceFunction from './performanceImprovement/debouncingFunction';
import ThrottlingFunction from './performanceImprovement/throttlingFunction';
import UseEffectHook from './hooks/useeffecthooks';
import UseStateHookTheme from './hooks/usestatehooks';
import Usememohook from './hooks/usememohooks';
import Simplecustomhook from './hooks/customHooks/simplecustomhook';
const App = () => {
  return (
   <>
   <Switch>
...
<Route path="/debounce" component={DebounceFunction} />
<Route path='/throttle' component={ThrottlingFunction} />
<Route path='/useeffecthook' component={UseEffectHook} />
<Route path='/usestatehook' component={UseStateHookTheme} />
<Route path="/usememohook" component={Usememohook} />
<Route path="/simplecustomhook" component={Simplecustomhook} />
